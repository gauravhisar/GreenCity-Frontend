...
const useToolbarStyles = makeStyles((theme) => ({
  ...
  function exportToExcel(plots){
    let rows = plots.map((plot)=>{
        return {
            ...
            PLC: plot.plc,
            Amount: plot.amount,
            Dealer: plot.deal ? plot.deal.dealer.name : "",
            ...
            "Next Due Date": plot.deal && plot.deal.unpaid_dues.length ? plot.deal.unpaid_dues[0].due_date : "",
            "Payable Amount": plot.deal && plot.deal.unpaid_dues.length ? plot.deal.unpaid_dues[0].payable_amount : "",
 ...
 xlsx.writeFile(wb, 'plots.xlsx')
  ...
  export default function EnhancedTableToolbar(props) {
    ...
    const { numSelected,setCurrentlyCreating, plots } = props;
      ...
      >
        ...
        {numSelected > 0 ? (
          ...
          <Tooltip title="Add Plot">
            <IconButton aria-label="add plot"  onClick = {()=>{

...
export default function Deal({ title, base_url, project_id, plot_details, setPlotDetails, index }) {
	...
	// else {
		return (
			<>
			{editing_view
			? <AddorEditDeal title = "Deals" base_url={base_url} project_id = {project_id} plot_details={plot_details} setPlotDetails={setPlotDetails} index={plot_details.id} setEditingView={setEditingView}  />
			:	
			<>
				<WarningDialog/>
						...
						<div className="card-text">
							<form>
								<div className="row mb-3">
									<div className="col-sm-3" style={verticallyCenter} onClick = {()=>{ history.push(`/customers/${plot_details.deal.customer.id}`) }}>
									...
									<div className="col-sm-2" style={verticallyCenter}>
										<TextField label="CustomerNo" InputProps={{ readOnly: true }} InputLabelProps={{ shrink: true}} margin="dense" size="small" color="primary" variant="standard" value={plot_details.deal.customer.contact_no} />
									</div>
								{/* </div>
								<div className="row mb-3"> */}
									<div className="col-sm-3" style={verticallyCenter} onClick = {()=>{ history.push(`/dealers/${plot_details.deal.dealer.id}`)}}>
									...
									<div className="col-sm-2" style={verticallyCenter}>
										<TextField label="DealerNo" InputProps={{ readOnly: true}} InputLabelProps={{ shrink: true}} margin="dense" size="small" color="primary" variant="standard" value={plot_details.deal.dealer.contact_no} />
									</div>
									<div className="col-sm-2" style={verticallyCenter}>
									...
									{/* <DeleteIcon style={{ margin: '5px 5px', cursor: "pointer" }} onClick={(e) => {e.preventDefault(); setCurrentlyDeleting(true)}} fontSize = "medium"/> */}
				...
				<div className="card col-lg-2 my-2">
					<div className="card-body">
						{/* <h5 className="card-title border-bottom pb-2">Deal</h5> */}
						<div className="card-text">
							<form>
								{/* <div className="row mb-3"> */}
									{/* <div className="col-sm-12" style={verticallyCenter} onClick = {()=>{ history.push(`/customers/${plot_details.deal.customer.id}`) }}>
										<TextField label="Customer Name" InputProps={{ readOnly: true }} margin="dense" size="small" color="primary" variant="standard" value={plot_details.deal.customer.name} />
									</div> */}
								...
								{/* </div>
								<div className="row mb-3"> */}
									{/* <div className="col-sm-12" style={verticallyCenter} onClick = {()=>{ history.push(`/dealers/${plot_details.deal.dealer.id}`)}}>
										<TextField label="Dealer Name" InputProps={{ readOnly: true }} margin="dense" size="small" color="primary" variant="standard" value={plot_details.deal.dealer.name} />
									</div> */}
									{/* <div className="col-sm-1" style={verticallyCenter}>
								...
								{/* </div>
								<div className="row mb-3"> */}
									<div className="col-sm-12" style={verticallyCenter}>
